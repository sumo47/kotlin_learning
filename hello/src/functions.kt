...
// default parameter - if argument passed then it will give result according to argument but if argument will not passed then result will print according to default value of parameter
