...
//    for (obj in objects){
//        obj.drag()  // here drag function will not work if Shape class does not exist drag
// function
//    }
// }
//
...
//
// abstract class Shape() : Draggable{ // inherit Draggable interface , now all subclass of shape
// can access of drag method
